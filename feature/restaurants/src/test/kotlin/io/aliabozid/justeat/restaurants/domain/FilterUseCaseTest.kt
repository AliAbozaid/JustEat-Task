...
class FilterUseCaseTest {
	...
	@Test
	fun `given filterRestaurant is called when filter is filled then the data should be filtered`() =
		runBlockingTest {
    ...
    @Test
	fun `given filterRestaurant is called when filter is not filled then the data should be filtered`() =
		runBlockingTest {
